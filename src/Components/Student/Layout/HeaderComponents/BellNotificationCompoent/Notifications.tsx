...
export default function BasicTabs() {
  ...
  const getNotification = async () => {
    const res = await fetch(`http://localhost:3000/api/Notification/getNotification`, {
      method: `GET`, // or 'PUT'
      headers: {
  ...
  return (
    <div style={{ width: `24em` }}>
      ...
      >
        ...
        <Link
          onClick={() => router.push(`/SeeAllNotificationPage`)}
          sx={{
            border: `none`,
            textDecoration: `none`,
            p: `3px 7px 3px 7px`,
            cursor: `pointer`,
            color: `#168b88`,
            backgroundColor: `#dbeae6`,
            '&:hover': { backgroundColor: `#168b88`, color: `#dbeae6` },
            fontSize: `12px`,
            fontWeight: `500`,
      ...
      <Box>
        ...
        >
          ...
          <Tab
            ...
            disableRipple
            label={
              <StyledBadge color="success" badgeContent={0}>
                <Typography
                  color="#3e3c76"
                  fontFamily={`montserrat`}
                  fontSize={12}
          ...
          >
            ...
            <Box>
              <Typography
                ...
                fontWeight={600}
              >
                The status of your Degree Attestation System application 1718428
                has been updated to Saved
              </Typography>
              <Typography
                fontFamily={`montserrat`}
                fontSize={12}
      ...
      <TabPanel value={value} index={2}>
        ...
        {notification.map((notification) => (
          <Box marginY={0} key={notification._id}>
